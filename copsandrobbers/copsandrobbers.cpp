...
signed main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        for (int j = 0; j < m; j++)
        {
            ...
            {
                mf.add_edge(i * m + j, i * m + j + m * n, costs[grid[i][j] - 'a']);
            }
            else
            {
                mf.add_edge(i * m + j, i * m + j + m * n, INF);
            }
            ...
            for (int k = 0; k < 4; k++)
            {
                ...
                {
                    mf.add_edge(i * m + j + m * n, 2 * m * n, INF);
                }
                else
                {
                    mf.add_edge(i * m + j + m * n, xx * m + yy, INF);
                }
            }
        }
    }
